...
import System 
import time
# We add ViewOrientationType back to the imports
...
if not (p1 and p2 and p3 and total_def and def_x and def_y and def_z and eqv_strain):
    ...
    for i, case in enumerate(load_cases):
        ...
        try:
            ...
            # --- PART 1: DATA EXPORT (Safety First) ---
            ...
            # --- PART 2: VISUAL EXPORT (Perfect Orthogonal Views) ---
            ...
            # View 3: Right
            ExtAPI.Graphics.Camera.SetSpecificViewOrientation(ViewOrientationType.Right)
            ExtAPI.Graphics.Camera.SetFit()
            ExtAPI.Graphics.Camera.Zoom(0.7)
            time.sleep(3)
            ...
            # View 4: Top (Bonus: Excellent for AI training)
            ExtAPI.Graphics.Camera.SetSpecificViewOrientation(ViewOrientationType.Top)
            ExtAPI.Graphics.Camera.SetFit()
            ExtAPI.Graphics.Camera.Zoom(0.7)
            time.sleep(3)
